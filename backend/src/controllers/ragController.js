...
const runPythonRag = (query, rows, k) => {
...
const getAllRagDocuments = async (req, res, next) => {
  try {
...
const addRagDocument = async (req, res, next) => {
  try {
...
const clearRagDocuments = async (req, res, next) => {
  try {
